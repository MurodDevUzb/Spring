...
public class CommentController {
    ...
    public ResponseEntity<Object> createComment(@Valid @RequestBody CommentDTO commentDTO,
        ...
        Comment comment = commentService.savaComment(Long.parseLong(postId),commentDTO,principal);
